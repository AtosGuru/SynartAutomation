      ...
      <div className='bg-gray-900'>
        <div className='container px-5 py-24 mx-auto px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20'>
          ...
          <div className='flex flex-wrap -m-4 '>
            <div className='container px-5 py-24 mx-auto px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20'>
                <Fade up>
                  <h2 className=' max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-white sm:text-4xl md:mx-auto' style={{textAlign: 'center'}}>
                ...
                <Jello>
                    <div class="grid grid-flow-col grid-rows-1 grid-cols-5 gap-5 img-div" style={{margin: 'auto'}}>
                      <div className="">
